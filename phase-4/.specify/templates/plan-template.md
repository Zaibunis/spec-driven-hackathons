...
- [ ] AI logic implemented using OpenAI Agents SDK and MCP tools.
- [ ] MCP tools are stateless and schema-defined.
- [ ] Conversation context is rebuilt from database each request.
- [ ] All AI actions are traceable and persisted in database.
